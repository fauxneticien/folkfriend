...
> **Note:** this documentation site was generated by
> [Claude Code](https://www.anthropic.com/claude-code) on a fork of the
> FolkFriend repository. It is not part of the upstream project and is
> not endorsed by its author.
> [FolkFriend](https://folkfriend.app) and all of the code described here
> are by [Tom Wyllie](https://github.com/TomWyllie/folkfriend), licensed
> GPL-3.0-only.
